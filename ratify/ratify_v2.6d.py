...
def look_for_match(vals, vLUT, condouts, pCount, mCode):
    ...
    while there_is_a_match is False and len(condouts) > 0:
        ...
        #print(str(match_list),pCount,len(vals))
        if match_count != pCount and mCode == "more":
            mis_match_error(str(match_list), str(pCount))
        elif match_count == pCount and mCode == "low":
            continue
